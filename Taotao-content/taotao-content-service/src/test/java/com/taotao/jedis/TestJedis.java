...
public class TestJedis {
	...
	public void testJedis() throws Exception {
		...
		Jedis jedis = new Jedis("106.14.118.199", 6379);
		// 直接操作数据库
	...
	public void testJedisCluster() throws Exception {
		...
		// 向集合中添加节点
		nodes.add(new HostAndPort("106.14.118.199", 7001));
		nodes.add(new HostAndPort("106.14.118.199", 7002));
		nodes.add(new HostAndPort("106.14.118.199", 7003));
		nodes.add(new HostAndPort("106.14.118.199", 7004));
		nodes.add(new HostAndPort("106.14.118.199", 7005));
		nodes.add(new HostAndPort("106.14.118.199", 7006));
